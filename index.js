...
const trackWetProbabilities = [
    ...
    { name: "Austria", wetChance: 153 / 365 / 3},
    { name: "Australia", wetChance: 56 / 365 / 3},
    { name: "Azerbaijan", wetChance: 60 / 365 / 3},
    { name: "Bahrain", wetChance: 20 / 365 / 3},
    { name: "Belgium", wetChance: 167 / 365 / 3},
    { name: "Brazil", wetChance: 125 / 365 / 3},
    { name: "Canada", wetChance: 170 / 365 / 3},
    { name: "China", wetChance: 134 / 365 / 3},
    { name: "France", wetChance: 79 / 365 / 3},
    { name: "Great Britain", wetChance: 143 / 365 / 3},
    { name: "Hungary", wetChance: 107 / 365 / 3},
    { name: "Imola", wetChance: 105 / 365 / 3},
    { name: "Italy", wetChance: 133 / 365 / 3},
    { name: "Japan", wetChance: 134 / 365 / 3},
    { name: "Las Vegas", wetChance: 26 / 365 / 3},
    { name: "Mexico", wetChance: 134 / 365 / 3},
    { name: "Miami", wetChance: 133 / 365 / 3},
    { name: "Monaco", wetChance: 107 / 365 / 3},
    { name: "Netherlands", wetChance: 135 / 365 / 3},
    { name: "Portugal", wetChance: 70 / 365 / 3},
    { name: "Qatar", wetChance: 9 / 365 / 3},
    { name: "Saudi Arabia", wetChance: 26 / 365 / 3},
    { name: "Singapore", wetChance: 175 / 365 / 3},
    { name: "Spain", wetChance: 106 / 365 / 3},
    { name: "USA", wetChance: 106 / 365 / 3},
];

const multiplierWeight = 1;
...
const getWeightedWeatherTypeMultipliers = wetChance => {
    ...
    return getWeightedWeatherMultipliers(weightedWeatherProportions)
};
...
const stickyWeight = 3.5;
const expectedWeatherWeight = 1.5;

const getExpectedWeatherIndex = (multipliers) => {
...
const getNextStintWeatherProbabilities = (currentStintWeatherType, wetChance) => {
    ...
    const expectedWeatherIndex = getExpectedWeatherIndex(weatherMultipliers);
    ...
    const nextStintWeatherProbabilities = weatherTypes.map((weatherType, index) => {
        ...
        const differenceToExpectedWeather = Math.abs(expectedWeatherIndex - index);
        const weatherTypeProbability = ((1 / (Math.pow(differenceToCurrentWeather + 1, stickyWeight + 1) + Math.pow(differenceToExpectedWeather + 1, expectedWeatherWeight + 1))) * getWeatherTypeProbability(weatherType, wetChance));
